...
labels = np.array(['Pancreatic ductal adenocarcinoma',
       ...
       'Solid Pseudopapillary Tumor (solid cystic tumor) or papillary epithelial tumor, papillary cystic tumors)',
       ...
       'Sarcoidosis', 'Castleman Disease of the Pancreas'], dtype=object)

all_features = np.array(['small', 'Large', 'Single', 'Multiple', 'Diffuse', 'Solid', 'solid_with_necrosis', 
 'Calcification', 'haemorrhage', 'Hypovascular', 'Hypervascular', 'duct_obst', 'Head', 'body', 'duodenum'])

positive = np.array([[0.71 , 0.96 , 0.71 , 0.76 , 0.31 , 0.01 , 0.26 , 0.01 , 0.91 ,
        0.76 , 0.36 , 1.01 , 1.01 , 0.86 , 0.66 ],
       [0.36 , 0.06 , 0.51 , 0.46 , 0.86 , 1.01 , 0.81 , 1.01 , 0.26 ,
        0.36 , 0.76 , 0.01 , 0.01 , 0.21 , 0.56 ],
       [0.96 , 1.01 , 0.81 , 0.26 , 1.01 , 1.01 , 1.01 , 0.01 , 1.01 ,
        0.01 , 1.01 , 1.01 , 1.01 , 0.085, 0.21 ],
       [0.01 , 0.01 , 0.31 , 0.81 , 0.01 , 0.01 , 0.01 , 0.085, 0.01 ,
        0.41 , 0.01 , 0.01 , 0.01 , 0.81 , 0.46 ],
       [0.01 , 0.01 , 0.01 , 0.06 , 0.01 , 0.01 , 0.01 , 0.91 , 0.01 ,
        0.36 , 0.01 , 0.01 , 0.01 , 0.26 , 0.76 ],
       [0.91 , 0.96 , 0.98 , 0.98 , 0.11 , 0.26 , 0.06 , 1.01 , 0.56 ,
        0.66 , 0.21 , 1.01 , 1.01 , 1.01 , 0.71 ],
       [0.76 , 0.03 , 0.03 , 0.03 , 0.935, 0.91 , 0.96 , 0.11 , 0.66 ,
        0.56 , 0.96 , 0.01 , 0.01 , 0.01 , 0.51 ],
       [0.02 , 0.36 , 0.11 , 0.11 , 0.085, 0.21 , 0.36 , 0.01 , 0.085,
        0.085, 0.31 , 0.01 , 0.01 , 0.01 , 1.01 ],
       [0.21 , 0.01 , 0.01 , 0.01 , 0.16 , 0.21 , 0.36 , 0.01 , 0.11 ,
        0.11 , 0.36 , 0.01 , 0.01 , 0.01 , 0.085],
       [0.91 , 0.06 , 0.06 , 0.06 , 0.11 , 0.11 , 0.01 , 1.01 , 0.36 ,
        0.66 , 0.66 , 1.01 , 0.86 , 1.01 , 0.61 ],
       [0.11 , 0.96 , 0.96 , 0.96 , 0.935, 0.91 , 0.01 , 0.01 , 0.66 ,
        0.41 , 0.46 , 0.01 , 0.16 , 0.01 , 0.46 ],
       [0.31 , 0.01 , 0.01 , 0.01 , 0.11 , 0.01 , 0.11 , 0.16 , 0.06 ,
        0.16 , 0.01 , 0.01 , 0.01 , 0.01 , 0.01 ],
       [0.71 , 0.61 , 0.61 , 0.61 , 0.86 , 0.31 , 0.76 , 0.81 , 0.26 ,
        0.56 , 0.66 , 0.01 , 0.01 , 0.56 , 0.81 ],
       [0.46 , 0.61 , 0.61 , 0.61 , 0.16 , 0.81 , 0.36 , 0.41 , 0.76 ,
        0.61 , 0.56 , 0.01 , 1.01 , 0.56 , 0.41 ],
       [0.02 , 0.01 , 0.01 , 0.01 , 0.01 , 0.01 , 0.085, 0.01 , 0.06 ,
        0.11 , 0.01 , 1.01 , 0.01 , 0.01 , 0.01 ]])

negative = np.array([[0.95214471, 0.93529426, 0.95214471, 0.94877462, 0.97910544,
       ...
       [0.94883101, 0.94601953, 0.94489493, 0.94489493, 0.99381474,
...
prevalence = np.array([0.11111111, 0.06666667, 0.06666667, 0.06666667, 0.06666667,
       0.06666667, 0.05555556, 0.05555556, 0.06666667, 0.06666667,
       0.07777778, 0.06666667, 0.06666667, 0.05555556, 0.04444444])
